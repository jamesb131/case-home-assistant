...
OPTION_ENV_MAP = {
    ...
    "zigbee_mqtt_server": "ZIGBEE_MQTT_SERVER",
    "zigbee_mqtt_username": "ZIGBEE_MQTT_USERNAME",
    "zigbee_mqtt_password": "ZIGBEE_MQTT_PASSWORD",
    "zigbee_mqtt_base_topic": "ZIGBEE_MQTT_BASE_TOPIC",
    "zigbee_mqtt_timeout": "ZIGBEE_MQTT_TIMEOUT",
    "zigbee_meter_devices": "ZIGBEE_METER_DEVICES",
    "zigbee_meter_poll_interval": "ZIGBEE_METER_POLL_INTERVAL",
    "zigbee_environment_devices": "ZIGBEE_ENVIRONMENT_DEVICES",
    "zigbee_environment_poll_interval": "ZIGBEE_ENVIRONMENT_POLL_INTERVAL",
